...
void MenuState::render() {
	...
	font.drawString("Press 'r' to restart restaurant", ofGetWidth() / 2, ofGetHeight() / 2 + 120);
	font.drawString("Press 'q' to quit", ofGetWidth() / 2, ofGetHeight() / 2 + 140);
	font.drawString("Press 's' to serve burger", ofGetWidth() / 2, ofGetHeight() / 2 + 160);
	font.drawString("Press 'u' to undo", ofGetWidth() / 2, ofGetHeight() / 2 + 180);
